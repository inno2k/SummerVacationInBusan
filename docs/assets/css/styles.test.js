...
assert.match(css, /\.ops-card__links\{[^}]*display:flex;[^}]*flex-wrap:wrap;[^}]*gap:/);
assert.match(css, /\.ops-card__links a\{[^}]*color:var\(--sea\)/);
assert.match(css, /@media\(max-width:760px\)\{\.ops-card__links\{[^}]*flex-wrap:wrap/);
assert.match(css, /\.optional-experience-list\{/);
assert.match(css, /\.optional-experience\{/);
assert.match(css, /\.meal-fallback-list\{/);
assert.match(css, /\.meal-fallback-link\{/);
assert.match(css, /@media\(max-width:760px\)\{\.optional-experience-list\{/);
